...
import ResellerTicket from "./components/ResellerTicket";
...
const App = ({isServerInfo}) => {
    ...
    return (
        <>
            <Router>
                <div style={{marginTop:'30px',marginBottom:'70px',borderBottom: '1px solid rgb(230, 232, 236)'}}>
                <nav className="menuBar container" >
                    <div className="logo">
                        <NavLink to="/home">
                            <img src='https://afritickets.events/images/afri.png' alt="logo" />
                        </NavLink>
                    </div>
