...
function NFTTokenIds({ inputValue, setInputValue }) {
  ...
  const queryCreatedMarketItems = useMoralisQuery("CreatedMarketTokens");
  const fetchMarketTokens = JSON.parse(
    JSON.stringify(queryCreatedMarketItems.data, [
      "objectId",
      "createdAt",
      "price",
      "ticketContract",
  ...
  console.log(fetchMarketTokens,'market item data here')

  const purchaseItemFunction = "createMarketSale";
  const NFTCollections = getCollectionsByChain(chainId);
  console.log(chainId,'chain Id',NFTCollections)
  ...
  async function purchase() {
    ...
    const ops = {
      ...
      abi: contractABIJson,
      params: {
        ticketContract: nftToBuy.token_address,
        itemId: itemID,
      },
      msgValue: tokenPrice,
    };
  ...
  async function updateSoldMarketItem() {
    ...
    const marketList = Moralis.Object.extend("CreatedMarketTokens");
  ...
  const getMarketItem = (nft) => {
    ...
    const result = fetchMarketTokens?.find(
      (e) =>
        e.ticketContract === nft?.token_address &&
