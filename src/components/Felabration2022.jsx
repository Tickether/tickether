...
import ticketjson from '../Felabration_2022.json'

const ticketAddress = '0x3c3174b3b188a016faf90018a3321b1b57ba6f65';

function Felabration() {
                ...
                <Row gutter={30}>
                    <Col span={12}>
                        <div className="card-content-data">
                            ...
                            <h1 className="event-detail-heading">Felabration 2022</h1>
                            <p className="event-desc">Felabration is an annual music festival conceived in 1998 by Yeni Anikulapo-Kuti in memory and celebration of her father Fela Kuti, a Nigerian musician and human rights activist known for pioneering the afrobeat genre of music.</p>
                            <div className="event-detail-price">ETH 0.03</div>
                        </div>
                        <div style={{width: '80%'}}>
                            {isConnected ? (
                                <div>
                    ...
                    <Col span={12}>
                        <div>
                            <img alt="example" className="img-event-detail"
                                 src="https://gateway.pinata.cloud/ipfs/QmPm1EiKRAXk5tw9psiV5PT5JctuUvkUJ3E71qopYQCmUx"/>
                        </div>
                    </Col>
                    <Col span={24}>
