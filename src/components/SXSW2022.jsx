...
import ticketjson from '../SXSW_2022.json'

const ticketAddress = '0xf710f3e8be1180a3a4863330d5009278e799d4a8';
        ...
        if (window.ethereum) {
            ...
            try {
                const response = await contract.mint(BigNumber.from(mintAmount), {
                    value: ethers.utils.parseEther((0.025 * mintAmount).toString())
                });
                ...
                <Row gutter={30}>
                    <Col span={12}>
                        <div className="card-content-data">
                            ...
                            <h1 className="event-detail-heading">SXSW 2022</h1>
                            <p className="event-desc">(South by SouthWest) A music, film and emerging technology festival held annually in Austin, Texas by SXSW Inc. It started in 1987 as a music festival and grew to the largest of its kind in the world with more than 2,000 performers and bands.</p>
                            <div className="event-detail-price">ETH 0.025</div>
                        </div>
                        <div style={{width: '80%'}}>
                            {isConnected ? (
                                <div>
                    ...
                    <Col span={12}>
                        <div>
                            <img alt="example" className="img-event-detail"
                                 src="https://gateway.pinata.cloud/ipfs/QmU11ReSVkm3BhQ6dFxwVm94Q4Xhtr6vK1E2mmaeQ1inGg"/>
                        </div>
                    </Col>
                    <Col span={24}>
