...
import ticketjson from '../BurningMan_2022.json'

const ticketAddress = '0xa29365C2b60FcaEadeef0784052E4fA40d6645b3';
        ...
        if (window.ethereum) {
            ...
            try {
                const response = await contract.mint(BigNumber.from(mintAmount), {
                    value: ethers.utils.parseEther((0.011 * mintAmount).toString())
                });
                ...
                <Row gutter={30}>
                    <Col span={12}>
                        <div className="card-content-data">
                            ...
                            <h1 className="event-detail-heading">BurningMan 2022</h1>
                            <p className="event-desc">Burning Man is an annual event in Nevada's Black Rock Desert, where people gather for around nine days to celebrate artistic self-expression and the building of a community intended to be temporarily self-sufficient.</p>
                            <div className="event-detail-price">ETH 0.011</div>
                        </div>
                        <div style={{width: '80%'}}>
                            {isConnected ? (
                                <div>
