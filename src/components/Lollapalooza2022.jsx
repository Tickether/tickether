...
import ticketjson from '../Lollapalooza_2022.json'

const ticketAddress = '0x5d5d273285ef0fa97edcb4d781df8ff1ef72192a';

function Lollapalooza() {
                ...
                <Row gutter={30}>
                    <Col span={12}>
                        <div className="card-content-data">
                            ...
                            <h1 className="event-detail-heading">Lollapalooza 2022</h1>
                            <p className="event-desc">Lollapalooza, annual Chicago rock festival that features dozens of hip-hop, techno, and alternative rock performers over a four-day period.</p>
                            <div className="event-detail-price">ETH 0.04</div>
                        </div>
                        <div style={{width: '80%'}}>
                            {isConnected ? (
                                <div>
                    ...
                    <Col span={12}>
                        <div>
                            <img alt="example" className="img-event-detail"
                                 src="https://gateway.pinata.cloud/ipfs/QmbFXK7EX41sAGD9ht3UzjJDA3uCAqa4rW6oM1YfpRidL2"/>
                        </div>
                    </Col>
                    <Col span={24}>
