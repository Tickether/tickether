...
import ticketjson from '../Coachella_2022.json'

const ticketAddress = '0xA1EAbcaC0144F554EaE2cEEA3cd77Cf6F7d707B8';
                ...
                <Row gutter={30}>
                    <Col span={12}>
                        <div className="card-content-data">
                            ...
                            <h1 className="event-detail-heading">Coachella 2022</h1>
                            <p className="event-desc">Coachella is the popular short name for the Coachella Valley Music and Arts Festival, an annual music festival held in Indio, California. The festival includes dozens of concerts across multiple stages by popular artists from a variety of genres, including hip hop, rock, and pop.</p>
                            <div className="event-detail-price">ETH 0.02</div>
                        </div>
                        <div style={{width: '80%'}}>
                            {isConnected ? (
                                <div>
