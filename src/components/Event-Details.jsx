...
import afrochella2022 from '../Afrochella2022.json'

const afrochella2022Address = '0xF2D1A8b6DC5b69f39cbc9e91F5b62528812c0e63';
                ...
                <Row gutter={30}>
                    <Col span={12}>
                        <div className="card-content-data">
                            ...
                            <h1 className="event-detail-heading">PATORANKING SHOW</h1>
                            <p className="event-desc">Digital training on video editing ,graphic design, cartoon
                                creation , animation creation ,Oil painting, Ebook cover mockup, bulk sms messaging,
                                Google ads setting ,3D ebook cover etc. The organisation is hosting this online Training
                                to empower youth on the profitable use of their smartphones. Take the opportunity now .
                                Registeration fee only .</p>
                            <div className="event-detail-price">₵5,000.00 - ₵1,000,000.00</div>
                        </div>
                        <div style={{width: '80%'}}>
                            {isConnected ? (
                                <div>
                    ...
                    <Col span={12}>
                        <div>
                            <img alt="example" className="img-event-detail"
                                 src="https://cdn.filestackcontent.com/GHN95ggTlShvPhjsPvXE"/>
                        </div>
                    </Col>
                    <Col span={24}>
